...
FCKConfig.ToolbarSets["Basic"] = [
	...
	['Source','Bold','Italic','-','OrderedList','UnorderedList']

] ;

FCKConfig.ToolbarSets["Box_preview"] = [
...
FCKConfig.ToolbarSets["Box_product"] = [

	['Source','Bold','Italic','TextColor','-','OrderedList','UnorderedList','-','Link','Unlink']

] ;


FCKConfig.ToolbarSets["BasicOriginal"] = [

	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About']

] ;

FCKConfig.ToolbarSets["BasicNosource"] = [
