...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	define('CONFIG_LOGIN_PASSWORD', 'test');
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../uploads/userfiles/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../uploads/userfiles/');	//accept relative path only
